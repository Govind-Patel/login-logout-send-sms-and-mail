...
<html lang="en">
  ...
  <body>
    ...
    <div class="container pt-5">
        <form action="code/registation.php" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input name ="addresss" type="text" class="form-control" id="inputAddress" placeholder="1234 Main St">
            </div> 
            <button type="submit" name="submit" class="btn btn-primary">Create A Account</button>
